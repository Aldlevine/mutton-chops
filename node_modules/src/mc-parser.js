...
module.exports = (function(){
  ...
  /**
   * Parses an HTML document into the MC ast
   *
   * @function MCParser#parseHTML
   * @param  {string} str - The MC html to parse
   * @return {Array} An array containing the ast
   */
  MCParser.prototype.parseHTML = function (str) {
